...
## Routing
### Switch vs. Router: 
• Ein Switch verbindet Geräte in einem lokalen Netzwerk und ermöglicht die 
...
### Ablauf ARP: 
• Das Adresse Resolution Protocol (ARP) wird verwendet, um die Zuordnung 
...
• Switch-Tabellen enthalten Informationen 
...
Routing-Tabellen werden verwendet, um den Weg für den 
...
Dies beinhaltet die Zuweisung von IP-Adressen, Subnetzmasken, 
